  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <span className="font-display text-xl font-bold tracking-tight">DayFlow</span>
        )}
      </div>
      ...
      <div className="p-2 border-t border-border space-y-0.5">
        ...
        {collapsed && (
          <button
            className="w-full flex justify-center py-2 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
            title="Notifications"
          >
        ...
        <div className={cn(
          ...
          {/* User color dot + avatar */}
          <div className="relative shrink-0">
            <div
              className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white ring-2 ring-offset-1"
              style={{
                backgroundColor: profile?.color || '#6366f1',
                ringColor: profile?.color || '#6366f1',
              }}
            >
              {profile?.avatar_url ? (
