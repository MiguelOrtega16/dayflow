...
export type NotificationType = 'status_update' | 'task_completed' | 'goal_completed' | 'goal_progress' | 'new_activity'
...
// Goals are standalone containers - they track progress based on linked tasks
export interface Goal {
  ...
  target_date: string | null   // YYYY-MM-DD deadline
  is_public: boolean
  created_at: string
  updated_at: string
